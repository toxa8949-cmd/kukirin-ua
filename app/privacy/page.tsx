  ...
  return (
    <PageShell breadcrumb="LEGAL · PRIVACY" title="Політика конфіденційності" subtitle="Як ми обробляємо ваші персональні дані відповідно до Закону України 'Про захист персональних даних'.">
      <article className="prose prose-invert max-w-3xl space-y-5 text-sm leading-relaxed text-white/75">
        ...
        <h2 className="text-xl font-medium text-white">1. Хто ми</h2>
        ...
        <h2 className="text-xl font-medium text-white">2. Які дані ми збираємо</h2>
        ...
        <h2 className="text-xl font-medium text-white">3. Для чого ми їх використовуємо</h2>
        <ul className="list-disc space-y-1 pl-5">
        ...
        <h2 className="text-xl font-medium text-white">4. Кому передаємо дані</h2>
        ...
        <h2 className="text-xl font-medium text-white">6. Ваші права</h2>
        ...
        <h2 className="text-xl font-medium text-white">7. Зміни в політиці</h2>
