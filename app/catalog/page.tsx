...
export default function CatalogPage() {
  return (
    <PageShell
      ...
      subtitle="6 електросамокатів — від міських до off-road флагманів. Усі офіційні, з гарантією 12 місяців."
    >
        ...
        {KUKIRIN_SCOOTERS.map((s) => (
          ...
          >
            <div className="mb-3 flex items-center justify-between">
              <span className="text-[10px] tracking-[0.2em] text-[#FF8A33]">{CATEGORY_LABELS[s.category]}</span>
              {s.badge && (
