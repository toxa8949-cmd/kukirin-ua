    ...
    <PageShell breadcrumb="WARRANTY · 12 МІСЯЦІВ" title="Гарантія" subtitle="Кожен самокат KUKIRIN — з офіційною гарантією виробника й українською сервісною підтримкою.">
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        ...
        <section className="rounded-sm border border-white/10 bg-[#0F0F0F] p-6">
          ...
          <ul className="space-y-2 text-sm text-white/70">
            <li className="flex gap-2"><XCircle size={16} className="mt-0.5 shrink-0 text-white/50" /> Витратні деталі: шини, гальмівні колодки, ручки</li>
            <li className="flex gap-2"><XCircle size={16} className="mt-0.5 shrink-0 text-white/50" /> Механічні пошкодження від падінь і ДТП</li>
            <li className="flex gap-2"><XCircle size={16} className="mt-0.5 shrink-0 text-white/50" /> Втручання в електроніку поза сервісом</li>
            <li className="flex gap-2"><XCircle size={16} className="mt-0.5 shrink-0 text-white/50" /> Експлуатація під дощем понад IPX4</li>
            <li className="flex gap-2"><XCircle size={16} className="mt-0.5 shrink-0 text-white/50" /> Перевантаження більше 120 кг для більшості моделей</li>
          </ul>
        </section>

        <section className="rounded-sm border border-white/10 bg-[#0F0F0F] p-6 md:col-span-2">
