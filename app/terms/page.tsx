  ...
  return (
    <PageShell breadcrumb="LEGAL · TERMS" title="Угода користувача" subtitle="Правила користування сайтом KUKIRIN.UA і умови продажу електросамокатів.">
      <article className="prose prose-invert max-w-3xl space-y-5 text-sm leading-relaxed text-white/75">
        ...
        <h2 className="text-xl font-medium text-white">1. Загальні положення</h2>
        <p>Користуючись Сайтом, ви погоджуєтесь з умовами цієї Угоди. Якщо не згодні — будь ласка, не використовуйте Сайт.</p>

        <h2 className="text-xl font-medium text-white">2. Замовлення</h2>
        ...
        <h2 className="text-xl font-medium text-white">3. Ціни</h2>
        ...
        <h2 className="text-xl font-medium text-white">4. Доставка й оплата</h2>
        ...
        <h2 className="text-xl font-medium text-white">5. Повернення</h2>
        ...
        <h2 className="text-xl font-medium text-white">6. Гарантія</h2>
        <p>Усі товари мають офіційну гарантію виробника KUKIRIN та сервісну підтримку від нас. Деталі — у розділі «Гарантія».</p>

        <h2 className="text-xl font-medium text-white">7. Інтелектуальна власність</h2>
        ...
        <h2 className="text-xl font-medium text-white">8. Контакти для запитань</h2>
