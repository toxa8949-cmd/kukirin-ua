  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        {/* Form */}
        <div className="rounded-sm border border-[#E8E6DE] dark:border-white/10 bg-white dark:bg-[#0F0F0F] p-6">
          <h2 className="mb-5 text-xl font-medium">Залиште заявку</h2>
          <form className="space-y-3">
            <input type="text" placeholder="Ім'я" className="w-full rounded-sm border border-[#E8E6DE] dark:border-white/15 bg-black px-4 py-3 text-sm placeholder:text-[#6C6A65] dark:text-white/30 focus:border-[#FF6B00] focus:outline-none" />
            <input type="tel" placeholder="+380 __ ___ __ __" className="w-full rounded-sm border border-[#E8E6DE] dark:border-white/15 bg-black px-4 py-3 text-sm placeholder:text-[#6C6A65] dark:text-white/30 focus:border-[#FF6B00] focus:outline-none" />
            <select className="w-full rounded-sm border border-[#E8E6DE] dark:border-white/15 bg-black px-4 py-3 text-sm focus:border-[#FF6B00] focus:outline-none">
            ...
            <textarea rows={3} placeholder="Коментар (необовʼязково)" className="w-full rounded-sm border border-[#E8E6DE] dark:border-white/15 bg-black px-4 py-3 text-sm placeholder:text-[#6C6A65] dark:text-white/30 focus:border-[#FF6B00] focus:outline-none" />
            <button type="button" className="w-full rounded-sm bg-[#FF6B00] px-6 py-3 text-xs font-medium tracking-[0.1em] text-white dark:text-black hover:bg-[#FF8A33]">
              ЗАПИСАТИСЬ
            </button>
          </form>
