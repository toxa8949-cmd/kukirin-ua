    ...
    <PageShell breadcrumb="ACCOUNT" title="Особистий кабінет" subtitle="Увійдіть, щоб бачити історію замовлень, бонусний рахунок і збережені адреси доставки.">
      <div className="mx-auto max-w-md rounded-sm border border-[#E8E6DE] dark:border-white/10 bg-white dark:bg-[#0F0F0F] p-6 sm:p-8">
        ...
        <form className="space-y-3">
          ...
          <button type="button" className="flex w-full items-center justify-center gap-2 rounded-sm bg-[#FF6B00] px-4 py-3 text-xs font-medium tracking-[0.1em] text-white dark:text-black hover:bg-[#FF8A33]">
      ...
      <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-sm border border-[#E8E6DE] dark:border-white/10 p-4 text-center">
