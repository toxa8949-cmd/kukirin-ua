  ...
  return (
    <PageShell breadcrumb="DELIVERY · УКРАЇНА" title="Доставка й оплата" subtitle="Швидко, прозоро, без передплати. Самокат їде до вас 1–3 дні, оплата при отриманні.">
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        <section className="rounded-sm border border-white/10 bg-[#0F0F0F] p-6">
          <Truck size={26} className="mb-3 text-[#FF6B00]" />
          <h2 className="mb-3 text-xl font-medium">Доставка</h2>
          <ul className="space-y-3 text-sm text-white/70">
            <li><span className="text-white">Нова Пошта</span> — відділення/поштомат: 1–2 дні, від 90 ₴ (для габаритних — за тарифом перевізника).</li>
            <li><span className="text-white">Курʼєр НП</span> — за адресою: 1–3 дні, від 120 ₴ + габаритне.</li>
            <li><span className="text-white">Самовивіз</span> — Київ / Львів / Одеса з сервісного центру, безкоштовно у будь-який день.</li>
            <li><span className="text-white">Безкоштовна доставка</span> при замовленні від 20 000 ₴ — Новою Поштою у відділення.</li>
          </ul>
        </section>
        ...
        <section className="rounded-sm border border-white/10 bg-[#0F0F0F] p-6">
          ...
          <ul className="space-y-3 text-sm text-white/70">
            <li><span className="text-white">При отриманні</span> — готівкою або карткою у відділенні НП.</li>
            <li><span className="text-white">Картою онлайн</span> — Visa / Mastercard, Apple Pay, Google Pay через LiqPay або WayForPay.</li>
            <li><span className="text-white">Розстрочка 0%</span> — ПриватБанк, Monobank: 3 / 6 / 12 платежів без переплати.</li>
            <li><span className="text-white">Безготівковий розрахунок</span> — для юридичних осіб з ПДВ.</li>
          </ul>
        </section>
